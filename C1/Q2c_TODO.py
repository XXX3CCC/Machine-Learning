# TODO: Copy from Q1a and/or Q1c as needed
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
plt.tight_layout()
plt.savefig('2(c)_The learning curve of the training loss' + '.jpg')
...
plt.tight_layout()
plt.savefig('2(c)_The learning curve of the validation risk' + '.jpg')
